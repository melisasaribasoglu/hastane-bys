<?php error_reporting(0);
 $baglan = @new mysqli('localhost', 'root', '', 'hastaneby');
...
<div class='box'>
  <div class='box-form'>
    ...
    <div class='box-login-title'>
      <div class='i i-login'></div><h2>Randevu Al</h2>
    </div>
    <form action="" name="randevu" id="randevu" enctype="multipart/form-data" method="POST">
      <div class='box-login'>
        <div class='fieldset-body' id='login_form'>
          ...
          <p class='field'>
            <label for='klinik'>Klinik Seçiniz</label>
            <select id="klinik" name="klinik" onchange="this.form.submit()" class="klinik">
            <?php
          ...
          <p class='field'>
            ...
            <p class='field'>
            <label for='randevutarihi'>Randevu Tarihini Seçiniz</label>
            <input type='date' id='tarih' name='tarih' title='Tarih Seçiniz' width='200px'/>
          ...
          <p class='field'>
            <label for='tc'>TC Kimlik Numaranızı Giriniz</label>
            <input type='number' id='tc' name='tc' title='TC Kimlik Numaranız' />
            <span id='valida' class='i i-close'></span>
          </p>
          <input type='submit' id='do_login' onclick="postwith();" value='Randevuyu Oluştur'/>
        </div>
      </div>
    </form>
  </div>
...
<script>
    function postwith () {
        ...
        document.getElementById("randevu").action ='./layout/_randevukayit.php';
